...
<head>
    ...
    <title>Liste des Utilisateurs - GouvTransfer</title>
...
<body>
    ...
    <div class="content-div">
        <h1 class="text-center trans" style="font-size: 2em;">Liste des Utilisateurs</h1>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="action-buttons">
                        <button class="btn-circle btn-edit" onclick="editUser(1)">
                            <i class="fas fa-pen"></i>
                        </button>
                        <button class="btn-circle btn-delete" onclick="deleteUser(1)">
                ...
                <tr>
                    <td>3</td>
                    <td>Utilisateur 3</td>
                    <td>utilisateur3@example.com</td>
                    <td>Groupe 3</td>
                    <td class="action-buttons">
                        <button class="btn-circle btn-edit" onclick="editUser(3)">
                            <i class="fas fa-pen"></i>
                        </button>
                        <button class="btn-circle btn-delete" onclick="deleteUser(3)">
                            <i class="fas fa-trash"></i>
                        </button>
                    </td>
                </tr>

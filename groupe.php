...
<head>
    ...
    <title>Ajout Groupe - GouvTransfer</title>
    ...
    <style>
        ...
        /* Styles généraux et animation de fond */
...
<body>
    ...
    <div class="content-div">
        <h1 class="text-center trans" style="font-size: 2em;">Ajout Groupe</h1>
        <form>
            <div class="mb-3">
                <input type="text" class="form-control form-control-lg form-input-text" id="groupName" name="groupName" placeholder="Nom du groupe" required>
            </div>
